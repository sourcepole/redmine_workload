...
* add user capacity custom fields for each weekday
  ...
  * Names for weekdays: workload_capacity_monday, workload_capacity_tuesday, workload_capacity_wednesday, workload_capacity_thursday, workload_capacity_friday, workload_capacity_saturday,   * Names: workload_capacity_monday, workload_capacity_tuesday, workload_capacity_wednesday, workload_capacity_thursday, workload_capacity_friday, workload_capacity_saturday,   * Names: workload_capacity_monday, workload_capacity_tuesday, workload_capacity_wednesday, workload_capacity_thursday, workload_capacity_friday, workload_capacity_saturday, workload_capacity_sunday
  * Format: Float
